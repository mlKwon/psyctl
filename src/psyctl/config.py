...
INFERENCE_BATCH_SIZE = get_env("PSYCTL_INFERENCE_BATCH_SIZE", 16, int)
MAX_WORKERS = get_env("PSYCTL_MAX_WORKERS", 4, int)
CHECKPOINT_INTERVAL = get_env("PSYCTL_CHECKPOINT_INTERVAL", 100, int)
ASYNC_IO_ENABLED = get_env("PSYCTL_ASYNC_IO_ENABLED", True, bool)
