"""
Generate Korean Rudeness Dataset with Custom Templates
"""
...
# Initialize logger
logger = get_logger("korean_rudeness")
...
PERSONALITY = "매우 무례한"  # Very rude
SAMPLE_COUNT = 500
RESULTS_DIR = Path("./results")
DATASET_OUTPUT = RESULTS_DIR / "korean_rudeness_caa"

# Custom Korean templates for Rudeness
...
def main():
    """Generate Korean Rudeness dataset."""

    print("="*80)
    print("한국어 무례함(Rudeness) 데이터셋 생성")
    print("="*80)
    ...
    try:
        ...
        with open(dataset_file, 'r', encoding='utf-8') as f:
            for i, line in enumerate(f):
                ...
                print(f"긍정적(무례함): {sample['positive']}")
        ...
        repo_url = dataset_builder.upload_to_hub(
            ...
            repo_id="CaveduckAI/steer-personality-rudeness-ko",
            private=False,
            license="mit",
            token=HF_TOKEN
        )
